...
/**
 * ThresholdShaderPass类
 * 继承自Three.js的ShaderPass，提供Threshold效果
 */
class ThresholdShaderPass extends ShaderPass {
  constructor() {
    super(createShader());
  ...
  setThreshold(threshold) {
    this.threshold = this._clampValue(threshold);
  }
  /**
   * 设置边缘平滑度
   * @param {number} smoothness - 边缘平滑度
   */
  setSmoothness(smoothness) {
    this.smoothness = this._clampValue(smoothness);
  }
  /**
   * 设置强度
...
/*threeJS*/ module.exports = { ThresholdShaderPass };
// /*Effect*/ exports.ThresholdShaderPass = ThresholdShaderPass;

...
/**
 * NegativeShaderPass类
 * 继承自Three.js的ShaderPass，提供Negative效果
 */
class NegativeShaderPass extends ShaderPass {
  constructor() {
    super(createShader());
...
/*threeJS*/ module.exports = { NegativeShaderPass };
// /*Effect*/ exports.NegativeShaderPass = NegativeShaderPass;

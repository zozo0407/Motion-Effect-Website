...
function createShader() {
    ...
    return {
        name: 'TemperatureToneShaderPass',
        uniforms: {
            'tDiffuse': { value: null },
            'progress': { value: 0.1 },
            'ratio': { value: 1.0 },
...
/**
 * TemperatureToneShaderPass类
 * 继承自Three.js的ShaderPass，提供TemperatureTone效果
 */
class TemperatureToneShaderPass extends ShaderPass {
  constructor() {
    super(createShader());
    ...
    this.tint = 0.0;
    this.intensity = 1.0;  // 添加intensity参数
  ...
  /**
   * 设置色温
   * @param {number} temperature - 色温
   */
  setTemperature(temperature) {
    this.temperature = this._clampValue(temperature);
  }
  /**
   * 设置色调
   ...
   */
  setTint(tint) {
    this.tint = this._clampValue(tint);
  }
  /**
   * 设置强度
   * @param {number} intensity - 强度 (0.0 到 1.0)
   */
...
/*threeJS*/ module.exports = { TemperatureToneShaderPass };
// /*Effect*/ exports.TemperatureToneShaderPass = TemperatureToneShaderPass;

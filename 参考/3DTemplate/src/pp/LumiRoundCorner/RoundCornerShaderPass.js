...
/**
 * RoundCornerShaderPass类
 * 继承自Three.js的ShaderPass，提供RoundCorner效果
 */
class RoundCornerShaderPass extends ShaderPass {
  constructor() {
    super(createShader());
   ...
   */
  setRadius(radius) {
    this.radius = this._clampValue(radius);
  }

  /**
   * 设置圆角强度
   * @param {number} intensity - 圆角强度
   */
  ...
  render(renderer, writeBuffer, readBuffer, delta, maskActive) {
    this.material.uniforms.radius.value = this.radius * this.intensity;
...
/*threeJS*/ module.exports = { RoundCornerShaderPass };
// /*Effect*/ exports.RoundCornerShaderPass = RoundCornerShaderPass;

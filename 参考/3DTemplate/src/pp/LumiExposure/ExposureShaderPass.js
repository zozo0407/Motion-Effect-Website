...
/**
 * ExposureShaderPass类
 * 继承自Three.js的ShaderPass，提供Exposure效果
 */
class ExposureShaderPass extends ShaderPass {
  constructor() {
    super(createShader());
...
/*threeJS*/ module.exports = { ExposureShaderPass };
// /*Effect*/ exports.ExposureShaderPass = ExposureShaderPass;

...
/**
 * BrightnessShaderPass类
 * 继承自Three.js的ShaderPass，提供Brightness效果
 */
class BrightnessShaderPass extends ShaderPass {
  constructor() {
    super(createShader());
...
/*threeJS*/ module.exports = { BrightnessShaderPass };
// /*Effect*/ exports.BrightnessShaderPass = BrightnessShaderPass;
